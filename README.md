...
[![Travis Status for eleboucher/machinery](https://travis-ci.org/eleboucher/machinery.svg?branch=master&label=linux+build)](https://travis-ci.org/eleboucher/machinery)
[![godoc for eleboucher/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/eleboucher/machinery/v1)
[![codecov for eleboucher/machinery](https://codecov.io/gh/eleboucher/machinery/branch/master/graph/badge.svg)](https://codecov.io/gh/eleboucher/machinery)

[![Go Report Card](https://goreportcard.com/badge/github.com/eleboucher/machinery)](https://goreportcard.com/report/github.com/eleboucher/machinery)
[![GolangCI](https://golangci.com/badges/github.com/eleboucher/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for eleboucher/machinery](https://sourcegraph.com/github.com/eleboucher/machinery/-/badge.svg)](https://sourcegraph.com/github.com/eleboucher/machinery?badge)
...
```go
import (
  "github.com/eleboucher/machinery/v2"
  backendsiface "github.com/eleboucher/machinery/v2/backends/iface"
  brokersiface "github.com/eleboucher/machinery/v2/brokers/iface"
  locksiface "github.com/eleboucher/machinery/v2/locks/iface"
)
...
```sh
go get github.com/eleboucher/machinery/v1
```

Or to get experimental v2 release:

```sh
go get github.com/eleboucher/machinery/v2
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/eleboucher/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/eleboucher/machinery/v1/log` package:
...
```go
import (
  "github.com/eleboucher/machinery/v1/config"
  "github.com/eleboucher/machinery/v1"
)
